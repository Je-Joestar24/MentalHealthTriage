...
import dashboardRouter, { psychologistDashboardRouter, companyAdminDashboardRouter } from './routes/dashboard.routes.js';
...
// Increased limit to 50MB for bulk imports (15k+ rows)
...
app.use('/api/company/dashboard', companyAdminDashboardRouter);
